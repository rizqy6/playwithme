			  	...
			  	<?php foreach ($artists as $key => $a): ?>
				    <tr>
				      ...
				      <td><div class="btn-group btn-group-sm">
					    <a href="artist.php?artist_id=<?= $a['artist_id'] ?>" title="<?= $a['artist_name'] ?>"  class="btn btn-primary" title="">View</a>
				      	<a href="admin_delete_artis.php?artist_id=<?= $a['artist_id'] ?> aritst_id=<?= $a['artist_id'] ?>" class="btn btn-danger" title="">Delete</a>
				      </div></td>
				    </tr> 
			  	<?php endforeach ?>
			  </tbody>
